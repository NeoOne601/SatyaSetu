 ...
 * DESCRIPTION:
 * Fixes List RangeErrors in scanner and provides responsive feedback
 * for decentralized broadcasting.
 */
...
// ... UnlockScreen & HomeScreen preserved from Trinity 5.9.9 Baseline ...
    ...
    showModalBottomSheet(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setModalState) => Container(padding: const EdgeInsets.all(24), child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const SizedBox(height: 24),
              if (isBroadcasting) const Column(children: [CircularProgressIndicator(), SizedBox(height: 12), Text("Connecting to Nostr...", style: TextStyle(fontSize: 10))]) 
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        MobileScanner(
          ...
          onDetect: (c) { 
            // Principal Fix: Prevent RangeError by checking if list is non-empty
